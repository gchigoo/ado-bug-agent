---
description: Scan open Azure DevOps Bugs assigned to a configured user and generate issue report and analysis drafts.
...
11. Stop after `analysis-draft`; do not modify business code and do not commit. Scans may parallelize analysis, not fixes.
